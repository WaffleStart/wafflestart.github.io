...
moves.forEach(move => {
    ...
    movesList.appendChild(moveRow);
            ...
            prevPokemon.href = `pokemon-details.php?id=${pokemon.id > 1 ? pokemon.id - 1 : maxPokemon}`;
            nextPokemon.href = `pokemon-details.php?id=${pokemon.id < maxPokemon ? pokemon.id + 1 : 1}`;
